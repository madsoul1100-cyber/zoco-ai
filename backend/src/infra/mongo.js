...
export async function connectMongo() {
  ...
  await Promise.all([
    ...
    db.collection("knowledgeChunks").createIndex({ kbId: 1 }),
    db.collection("knowledgeChunks").createIndex({ kbId: 1, docId: 1 }),
    ...
    db.collection("calls").createIndex({ exotelSid: 1 }, { sparse: true }),
