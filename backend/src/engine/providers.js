...
export const TTS_PROVIDERS = [
  ...
  },
  {
    ...
    env: "SARVAM_API_KEY",
    voices: [
      { id: "priya", label: "Priya (female, warm)", model: "bulbul:v3", gender: "female" },
      { id: "kavya", label: "Kavya (female, soft)", model: "bulbul:v3", gender: "female" },
      { id: "ishita", label: "Ishita (female)", model: "bulbul:v3", gender: "female" },
      { id: "shreya", label: "Shreya (female)", model: "bulbul:v3", gender: "female" },
      { id: "neha", label: "Neha (female)", model: "bulbul:v3", gender: "female" },
      { id: "ritu", label: "Ritu (female, bright)", model: "bulbul:v3", gender: "female" },
      { id: "simran", label: "Simran (female)", model: "bulbul:v3", gender: "female" },
      { id: "pooja", label: "Pooja (female)", model: "bulbul:v3", gender: "female" },
      { id: "shruti", label: "Shruti (female)", model: "bulbul:v3", gender: "female" },
      { id: "suhani", label: "Suhani (female)", model: "bulbul:v3", gender: "female" },
      { id: "roopa", label: "Roopa (female)", model: "bulbul:v3", gender: "female" },
      { id: "tanya", label: "Tanya (female)", model: "bulbul:v3", gender: "female" },
      ...
      { id: "anushka", label: "Anushka v2 (female)", model: "bulbul:v2", gender: "female" },
      { id: "manisha", label: "Manisha v2 (female)", model: "bulbul:v2", gender: "female" },
      { id: "vidya", label: "Vidya v2 (female)", model: "bulbul:v2", gender: "female" },
      { id: "arya", label: "Arya v2 (female)", model: "bulbul:v2", gender: "female" },
      { id: "abhilash", label: "Abhilash v2 (male)", model: "bulbul:v2", gender: "male" },
    ],
  },
  {
    id: "openai",
